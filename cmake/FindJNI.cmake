...
if(FINDJNI_JAVA_HOME)
    list(APPEND JAVA_AWT_INCLUDE_DIRECTORIES ${FINDJNI_JAVA_HOME}/include)
endif()
if (WIN32)
    foreach (_JNI_HINT IN LISTS _JNI_HINTS)
...
foreach(search ${_JNI_SEARCHES})
    find_library(JAVA_JVM_LIBRARY NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH ${_JNI_${search}_JVM})
    find_library(JAVA_AWT_LIBRARY NO_DEFAULT_PATH NO_CMAKE_FIND_ROOT_PATH ${_JNI_${search}_JAWT})
    if(JAVA_JVM_LIBRARY)
        break()
    endif()
endforeach()
